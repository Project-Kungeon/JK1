...
class C_Item_OpenInventory final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR C_Item_OpenInventory(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  C_Item_OpenInventory* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class S_Item_OpenInventory final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR S_Item_OpenInventory(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  S_Item_OpenInventory* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
inline uint64_t C_Item_OpenInventory::_internal_player_id() const {
  return player_id_;
}
inline uint64_t C_Item_OpenInventory::player_id() const {
  // @@protoc_insertion_point(field_get:game.item.C_Item_OpenInventory.player_id)
  return _internal_player_id();
}
inline void C_Item_OpenInventory::_internal_set_player_id(uint64_t value) {
  
  player_id_ = value;
}
inline void C_Item_OpenInventory::set_player_id(uint64_t value) {
  _internal_set_player_id(value);
...
inline uint64_t S_Item_OpenInventory::_internal_player_id() const {
  return player_id_;
}
inline uint64_t S_Item_OpenInventory::player_id() const {
  // @@protoc_insertion_point(field_get:game.item.S_Item_OpenInventory.player_id)
  return _internal_player_id();
}
inline void S_Item_OpenInventory::_internal_set_player_id(uint64_t value) {
  
  player_id_ = value;
}
inline void S_Item_OpenInventory::set_player_id(uint64_t value) {
  _internal_set_player_id(value);
...
inline ::message::InventorySlot* S_Item_OpenInventory::add_slots() {
  ::message::InventorySlot* _add = _internal_add_slots();
